...
namespace PersonalFinances.WEB.Controllers
{
    ...
    {
        private PersonalFinancesDBEntities _context;
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    StoreUserDetailsInSession(model.UserName);
        ...
        private void StoreUserDetailsInSession(string username)
        {
            ...
            AspNetUser currentUserDetails = _context.AspNetUsers.Where(u => u.UserName == username).First();
            UserModel ru = new UserModel();


            ru.Email = currentUserDetails.Email;
            ru.Name = currentUserDetails.Name;
            ru.Surname = currentUserDetails.Surname;
            ru.UserId = currentUserDetails.Id;
            ru.UserName = username;

            SessionManager.Userlogged = ru;
        }
